...
const createDynamicStyles = (isDark: boolean) => StyleSheet.create({
  ...
  freeText: { fontSize: 10, color: '#86EFAC', fontFamily: 'serif' },
  ...
  weightBadgeText: { color: '#22C55E', fontSize: 12, marginLeft: 4, fontFamily: 'serif' },
  ...
  bannerOverlay: { backgroundColor: isDark ? 'rgba(136, 19, 55, 0.7)' : 'rgba(244, 63, 94, 0.8)', padding: 20, borderRadius: 20 },
