...
const createDynamicStyles = (isDark: boolean) => StyleSheet.create({
  ...
  input: { backgroundColor: isDark ? '#0F172A' : '#FFF', borderRadius: 15, padding: 15, borderWidth: 1, borderColor: isDark ? '#1E293B' : '#E2E8F0', color: isDark ? '#FFF' : '#1E293B', fontFamily: 'serif' },
  ...
  workingSub: { color: '#E11D48', fontSize: 16, marginTop: 10, fontFamily: 'serif' },
  ...
  calBadgeText: { fontSize: 11, color: isDark ? '#FFF' : '#E11D48', fontFamily: 'serif' },
