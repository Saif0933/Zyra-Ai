...
const createDynamicStyles = (isDark: boolean) => StyleSheet.create({
  ...
  headerTitle: { fontSize: 24, color: isDark ? '#FFF' : '#1E293B', fontFamily: 'serif' },
  headerSub: { fontSize: 13, color: isDark ? '#94A3B8' : '#64748B', marginTop: 4, fontFamily: 'serif' },
  ...
  stepNum: { color: isDark ? '#64748B' : '#94A3B8', fontFamily: 'serif' },
  ...
  sectionTitle: { fontSize: 18, color: isDark ? '#FFF' : '#1E293B', marginBottom: 20, fontFamily: 'serif' },
  ...
  goalTitle: { fontSize: 16, color: isDark ? '#FFF' : '#1E293B', fontFamily: 'serif' },
  goalSub: { fontSize: 12, color: isDark ? '#94A3B8' : '#64748B', fontFamily: 'serif' },
  ...
  nextBtnText: { color: '#FFF', fontSize: 16, marginRight: 8, fontFamily: 'serif' },

  inputGroup: { marginBottom: 20 },
  labelRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 15 },
  inputLabel: { fontSize: 14, color: isDark ? '#FFF' : '#1E293B', marginLeft: 8, fontFamily: 'serif' },
  input: { backgroundColor: isDark ? '#111' : '#FFF', borderRadius: 15, padding: 15, borderWidth: 1, borderColor: isDark ? '#27272A' : '#E2E8F0', color: isDark ? '#FFF' : '#1E293B', fontFamily: 'serif' },
  ...
  activityTitle: { fontSize: 15, color: isDark ? '#FFF' : '#1E293B', fontFamily: 'serif' },
  activitySub: { fontSize: 12, color: isDark ? '#94A3B8' : '#64748B', fontFamily: 'serif' },
  ...
  backBtnText: { color: isDark ? '#FFF' : '#475569', fontFamily: 'serif' },
  ...
  generateBtnText: { color: '#FFF', fontFamily: 'serif' },
  ...
  workingTitle: { fontSize: 22, color: isDark ? '#FFF' : '#1E293B', marginTop: 40, fontFamily: 'serif' },
  workingSub: { color: '#22C55E', fontSize: 16, marginTop: 10, fontFamily: 'serif' },
  workingDesc: { color: isDark ? '#94A3B8' : '#64748B', textAlign: 'center', paddingHorizontal: 30, marginTop: 10, lineHeight: 20, fontFamily: 'serif' },
  ...
  planTitle: { fontSize: 16, color: '#FFF', marginLeft: 10, fontFamily: 'serif' },
  ...
  macroVal: { fontSize: 18, color: isDark ? '#FFF' : '#1E293B', fontFamily: 'serif' },
  macroUnit: { fontSize: 11, color: isDark ? '#94A3B8' : '#64748B', fontFamily: 'serif' },
  macroLabel: { fontSize: 10, color: isDark ? '#94A3B8' : '#64748B', marginTop: 2, fontFamily: 'serif' },
  ...
  mealTitle: { fontSize: 15, color: isDark ? '#FFF' : '#1E293B', fontFamily: 'serif' },
  mealTimeText: { fontSize: 12, color: isDark ? '#94A3B8' : '#64748B', fontFamily: 'serif' },
  calBadge: { backgroundColor: isDark ? '#064E3B' : '#DCFCE7', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  calBadgeText: { fontSize: 11, color: isDark ? '#4ADE80' : '#166534', fontFamily: 'serif' },
  mealDescList: { marginTop: 8 },
  mealDescText: { fontSize: 13, color: isDark ? '#94A3B8' : '#64748B', lineHeight: 20, fontFamily: 'serif' },
  ...
  tipText: { fontSize: 13, color: isDark ? '#94A3B8' : '#475569', fontFamily: 'serif' },
  
  createNewBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 20 },
  createNewText: { color: isDark ? '#94A3B8' : '#64748B', marginRight: 5, fontFamily: 'serif' }
});
